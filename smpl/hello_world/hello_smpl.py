...
m = load_model('/Users/Eddie/Desktop/code/simplify-master/code/models/basicModel_neutral_lbs_10_207_0_v1.0.0.pkl')

## Assign random pose and shape parameters
# m.pose[:] = np.random.rand(m.pose.size) * .2
# m.betas[:] = np.random.rand(m.betas.size) * .03
mesh = pickle.load(open('/Users/Eddie/Desktop/tmp/00000_body.pkl', 'rb'), encoding='iso-8859-1')
# m.pose[0:3] = -mesh['pose'][0:3]
m.pose[:] = mesh['pose']
m.betas[:] = mesh['betas']

## Write to an .obj file
outmesh_path = '/Users/Eddie/Desktop/hello_smpl.obj'
