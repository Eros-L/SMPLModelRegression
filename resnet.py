...
def _bottleneck_block_v1(inputs, filters, training, projection_shortcut,
                         strides, data_format, kernel_size=3):
...
def block_layer(inputs, filters, bottleneck, block_fn, blocks, strides,
                training, name, data_format, kernel_size=3):
    ...
    Args:
        ...
        data_format: The input format ('channels_last' or 'channels_first').
        kernel_size: The kernel size of the convolution layers (with default value of 3).
    ...
    inputs = block_fn(inputs, filters, training, projection_shortcut, strides,
                      data_format, kernel_size)

    for _ in range(1, blocks):
        inputs = block_fn(inputs, filters, training, None, 1, data_format, kernel_size)
